...
function Header() {
  return (
    <header className="w-full bg-black h-14 text-white flex items-center mx-auto sm:w-">
      <div className="flex items-center justify-between w-full max-w-7xl mx-auto p-5">
        <div className="hidden item justify-between items-center lg:flex">
          <Link href="/">
            <p className="logo text-2xl">Uber</p>
          </Link>
          <nav className="nav-menu lg:flex text-white">
            <Link
