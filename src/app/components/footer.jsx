      ...
      <div className='flex flex-col gap-10 max-w-7xl mx-auto lg:gap-20'>
        ...
        <div class="w-full max-w-7xl mx-auto">
          <div className="flex gap-5 w-full lg:w-1/2">
            <a href="https://play.google.com/store/apps/details?gl=US&hl=en_US&id=com.ubercab&referrer=singular_click_id%3D6caec709-ef02-4117-bbb4-9ac7211d339c">
            ...
            <a href="https://play.google.com/store/apps/details?gl=US&hl=en_US&id=com.ubercab&referrer=singular_click_id%3Dc6010f06-b286-4ed2-8b22-4ea3e7d9500e">
          ...
          <div className="w-full lg:w-1/2">
            <ul className="flex gap-10 justify-start font-txt-regular text-xs lg:justify-end lg:gap-5">
              <li className='text-white hover:text-gray-600'>
                <a href="https://www.uber.com/legal/document/?name=privacy-notice&uclick_id=2109ddad-1246-4e61-a3a5-2816b763c9e3">Privacidade
                </a>
              </li>
              <li className='text-white hover:text-gray-600'>
                <a href="https://www.uber.com/br/pt-br/about/accessibility/?uclick_id=2109ddad-1246-4e61-a3a5-2816b763c9e3">Acessibilidade
                </a>
              </li>
              <li className='text-white hover:text-gray-600'>
                <a href="https://www.uber.com/legal/document/?name=general-terms-of-use&uclick_id=2109ddad-1246-4e61-a3a5-2816b763c9e3">Termos
                </a>
              </li>
            </ul>
          </div>
