...
function SeventhSectionDG() {
  return (
    <div className="w-full flex sm:hidden ">
      <section className="first-section-black items-center justify-between block w-full max-w-7xl mx-auto py-5 px-5 bg-black sm:pt-10 sm:flex sm:pb-10 md:flex md:flex-col">
        <div className="left-side w-full   flex-col sm:ml-4 sm:h-auto sm:w-2/5 md:w-full lg:hidden">
          <h2 className="text-black text-3xl cta-text sm:mt-36 sm:text-4xl sm:leading-tight font-txt-bold md:mt-0">
            O app de parceiro
          </h2>
