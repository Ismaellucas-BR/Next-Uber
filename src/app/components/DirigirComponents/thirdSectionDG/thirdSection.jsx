      ...
      <section className="first-section-black items-center justify-between block w-full max-w-7xl mx-auto py-10 px-5 bg-white sm:py-14 sm:flex sm:flex-col">
        ...
        <div className="flex flex-col lg:flex-row gap-10 ">
          ...
          <Image
            ...
            <h4 className="font-txt-bold text-base">Faça o seu próprio horário</h4>
            <p className="text-[16px] font-txt-light">
          ...
          <div className="w-5">
          <Image
              src="/assets/credit_card_filled_1.jpg"
              alt="Mulher saindo do carro"
              layout="responsive"
              width={20} 
              height={20}
            ...
            <h4 className="font-txt-bold text-base">Ganhe dinheiro rapidamente</h4>
            <p className="text-[16px] font-txt-light">
          ...
          <Image
            ...
            <h4 className="font-txt-bold text-base">Obtenha suporte constante</h4>
            <p className="text-[16px] font-txt-light">
