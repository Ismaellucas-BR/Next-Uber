    ...
    <div className="w-full  mt-10 h-auto">
      <section className="first-section-black items-center justify-between block w-full max-w-7xl  py-10 px-5  bg-gray-100 sm:pt-10 sm:flex sm:pb-10 lg:max-w-full lg:pl-20 lg:py-20">
        <div className="left-side w-full   flex-col sm:ml-4 lg:h-auto lg:w-3/5">
          <h2 className="text-black text-3xl cta-text sm:text-5xl sm:leading-tight font-txt-bold lg:text-[40px] lg:mt-0">
            Sem veículo? Conheça as ofertas das locadoras
          </h2>
          <div className="loginRedirect flex items-center mt-4">
            <p className="text-black mt-4 border-b pb-1 font-txt">
      ...
      <section className="first-section-black items-center justify-between block w-full max-w-7xl mx-auto pt-5 px-5 mt-5 bg-white sm:pt-10 sm:flex sm:pb-10">
        <div className="left-side w-full   flex-col sm:ml-4 lg:h-auto lg:w-full">
          <h2 className="text-black text-3xl mb-10 cta-text sm:mt-36 sm:text-5xl sm:leading-tight font-txt-bold md:mt-3">
            Receba para dirigir
          </h2>
          <div className="md:flex md:gap-10 lg:w-full">
            <BlogComponent image="https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,w_558,h_314/v1581113810/assets/92/557e45-e7d5-44eb-90e1-35871c82f0ad/original/UberIM_004994-medium.jpg" title="Ganhe dinheiro a qualquer hora, em qualquer lugar" content="Quer você dirija apenas algumas horas de vez em quando ou use o
                ...
                proximidades." titleBtn="Veja como funciona" divClass="md:w-1/2"/>
            <BlogComponent image="https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,w_558,h_314/v1555099943/assets/d3/addd33-a2e2-406c-8040-6bac00bb7b8b/original/United-States-Vehicle-Solutions-Driver-With-Car4b.jpg" title="Precisa de um carro?" content="Não tem carro? Sem problemas. Se você quer se tornar um
                ...
                locadora." titleBtn="Consiga um carro" divClass="md:w-1/2"/>
          </div>
        </div>
      </section>
    </div>
