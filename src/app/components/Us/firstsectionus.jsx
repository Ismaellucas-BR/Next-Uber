...
import Accondion from "../FaqComponents/Accordion";
...
function Firstsectionus() {
  return (
    <>
      <section>
        <div className="bg-us-bg bg-center bg-no-repeat bg-cover w-full h-[500px] relative " style={{ backgroundImage: "url('https://www.uber-assets.com/image/upload/v1555699210/assets/63/cdb12d-a0cd-49fa-a6c0-6184a84d99ea/original/About_us_600.jpg')" }}>
      ...
      <section className="first-section-black items-center justify-between lg:block w-full max-w-7xl mx-auto pt-5 px-5 mt-5 bg-white sm:pt-10 sm:flex sm:pb-10">
        <div className="left-side w-full   flex-col sm:ml-4 lg:h-auto lg:w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-10 lg:w-full">
            <BlogComponent image={"https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,w_360,h_240/v1555540623/assets/cb/9b789f-167d-4a57-ac3a-c23060bfa9e8/original/170830_DaraAllHands_0I7A9940_R2.jpg"} title="Conheça nossa liderança" content="Estamos construindo uma cultura dentro da Uber que enfatiza fazer o que é certo, sem exceção, para usuários, motoristas parceiros e funcionários. Saiba mais sobre a equipe que está liderando essa iniciativa." titleBtn="Conheça nossa liderança" divClass="w-full"/>
            <BlogComponent image={"https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,w_360,h_240/v1619719896/assets/96/8d24b6-76cd-4dcb-8b89-e3125c603538/original/test2259.jpg"} title="Compromisso com a diversidade" content="Nosso objetivo é criar um local de trabalho inclusivo e que represente a diversidade das cidades que atendemos. Queremos que as pessoas sejam elas mesmas e que a autenticidade de cada uma seja motivo de orgulho. Esse ambiente receptivo a pessoas das mais diversas origens transformará a Uber em uma empresa melhor, tanto para os funcionários quanto para os usuários." titleBtn="Saiba mais sobre diversidade" divClass="w-full"/>
            <BlogComponent image={"https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,w_360,h_240/v1664822806/assets/b6/c8a24d-8e79-45a1-9e03-adead244ef0a/original/about-ec-image-01-thumb.png"} title="Agir com integridade" content="A Carta do Programa de Ética e Conformidade da Uber descreve nosso compromisso com a integridade nos mais altos níveis da empresa. A transparência é fundamental para uma cultura ética. Conseguimos isso por meio da nossa Linha Direta de Integridade e de várias iniciativas de conformidade eficientes e expansíveis." titleBtn="Veja como funciona" divClass="w-full"/>
          </div>
        </div>
      </section>
      <section className="first-section-black items-center justify-between block w-full max-w-7xl mx-auto pt-5 px-5 mt-5 bg-white sm:pt-10 sm:flex sm:pb-10">
        <div className="left-side w-full   flex-col sm:ml-4 lg:h-auto lg:w-full">
          ...
          <BoxWithIcon icon="https://www.uber-assets.com/image/upload/q_auto:eco,c_fill,w_24,h_24/v1542255691/assets/85/aa54ca-6b5b-48d7-82ac-20657ec53f51/original/megaphone-outlined.svg" title="Newsroom" content="Receba anúncios sobre parcerias, atualizações de apps, iniciativas e mais informações sobre o que acontece perto de você ou em qualquer lugar do mundo." showBtn="true" textBtn="Acesse o Newsroom"/>
          <BoxWithIcon icon="https://www.uber-assets.com/image/upload/q_auto:eco,c_fill,w_24,h_24/v1542250072/assets/b8/ea1bfc-215a-4246-97f2-a7ac03cd67bd/original/person_group-filled.svg" title="Blog" content="Descubra novos lugares, saiba mais sobre os produtos da Uber, conheça nossas parcerias e muito mais." showBtn="true" textBtn="Leia nossas publicações"/>
          <BoxWithIcon icon="https://www.uber-assets.com/image/upload/q_auto:eco,c_fill,w_24,h_24/v1542249793/assets/34/131a8c-392f-44a9-9745-3b8c110502f5/original/network-filled.svg" title="Relações com investidores" content="Baixe relatórios financeiros, confira os planos para o próximo trimestre e leia sobre nossas iniciativas de responsabilidade corporativa." showBtn="true" textBtn="Veja como funciona"/>
        </div>
        </div>
      </section>
      ...
      <a href="#" className="bg-black p-5 text-white rounded-xl font-txt">
        ...
        <div className="rightside lg:w-1/2 flex flex-col justify-center" >
          <img className="w-full" src="https://www.uber-assets.com/image/upload/q_auto:eco,c_fill,w_558,h_372/v1555543261/assets/cb/bed1c3-cb3e-4a20-9790-df8c8a2951fc/original/globe_background-01.svg" alt="globo terrestre" />
        </div>
      </section>
    </>
  );
